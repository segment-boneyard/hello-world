...
/*
  if config.setTransferId is switched on:
  ...
  otherwise it's just paginated through as usual
*/
...
module.exports = Resource()
  ...
  .consume(co(function* (client, obj, log, options) {
    if (options.transfer === undefined && config.setTransferId && obj.created < stopAfter) {
      return false;
    }
