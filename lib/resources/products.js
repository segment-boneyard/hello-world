...
module.exports = Resource()
  ...
  .consume(co(function* (client, obj) {
    ...
    if (Array.isArray(properties.attributes)) {
      properties.attributes = properties.attributes.join(',');
    }

    if (Array.isArray(properties.deactivate_on)) {
      properties.deactivate_on = properties.deactivate_on.join(',');
    }

    if (Array.isArray(properties.images)) {
      properties.images = properties.images.join(',');
    }
